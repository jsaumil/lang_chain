...
GOOGLE_API_KEY = os.getenv("GOOGLE_API_KEY") or 'AIzaSyDEHnFo2rSmuZJ_nI_vkyzM_T9ERg9TSl8'
...
# ==============================================================================
# 2. CONVERSATIONAL RAG CHAIN CLASS
# ==============================================================================
...
class ConversationalRAGChain:
    def __init__(self, pdf_path: str):
        ...
        classifier_chain = classifier_prompt | self.model | self.parser

        # 2. RAG Chain for admission-specific questions
...
ANSWER:""",
        ...
        # 3. General Chain for other questions
        general_prompt = PromptTemplate(
            template="""

You are an expert and helpful admissions counselor for Gandhinagar University. Your primary goal is to assist prospective students. Follow these instructions carefully:
...
ANSWER:""",
        ...
        # --- CORRECTED AND IMPLEMENTED ROUTING LOGIC ---
        # This branch uses the classifier's output to decide which chain to run.
        ...
        # This is the complete, final chain that automates the entire process.
        self.full_chain = (
    ...
    def invoke(self, user_input: str) -> str:
        """
        The main method now prepares inputs and calls the pre-built full_chain.
        """
...
if __name__ == "__main__":
    ...
    if not os.path.exists(pdf_file_path):
        ...
        print("Please create a dummy PDF with that name or provide the correct path.")
        exit()
